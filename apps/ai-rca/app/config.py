...
class Settings(BaseSettings):
    ...
    ai_provider: ProviderMode = Field(default="ollama", alias="AI_PROVIDER")
    ...
    ai_timeout_seconds: float = Field(default=30, alias="AI_TIMEOUT_SECONDS")
    ai_max_input_chars: int = Field(default=12000, alias="AI_MAX_INPUT_CHARS")
